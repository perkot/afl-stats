...
footywire3D <- get_footywire_stats(ids = 10209:10288) 
...
names(Season2017to2020) <- to_snake_case(names(Season2019))
...
# Standard .csv export 
write.csv(Season2017to2020, file = "Season2017to2020.csv",
          na = "", 
          row.names = FALSE)
```
