---
title: "Metres gained - the most critical statistic in the winning margin of AFL games"
author: "perkot"
date: "11 August 2020"
output:
...
# Print table 
kable(head(Season2019)) %>% #head limits to just top rows
...
kable(head(Matches_2019)) %>% #head limits to just top rows
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive", font_size = 8))
```
